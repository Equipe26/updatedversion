...
class pediaState extends State<pedia> {
  ...
  Specialty specialty = Specialty.pediatrie;
  List<Specialty> availableSpecialties = [];
  List<String> serviceId = [];
  final Map<String, String> serviceOptions = {
    'Conseil en allaitement': 'ped_allaitement ',
    'Consultation pédiatrique': 'ped_croissance ',
    'Bilan de croissance': 'ped_consult',
    'Vaccination infantile': 'ped_vaccin ',
  };
  @override
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Conseil en allaitement'),
                  const SizedBox(height: 20),
                  _buildOption('Consultation pédiatrique'),
                  const SizedBox(height: 20),
                  _buildOption('Bilan de croissance'),
                  const SizedBox(height: 20),
                  _buildOption('Vaccination infantile'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
