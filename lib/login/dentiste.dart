...
class Dentiste extends StatefulWidget {
  ...
  @override
  DentisteState createState() => DentisteState();
}

class DentisteState extends State<Dentiste> {
  // Use a Set to allow multiple selections
  Set<String> _selectedOptions = {};
  Specialty specialty = Specialty.dentiste;
  List<Specialty> availableSpecialties = [];
  List<String> serviceId = [];
   final Map<String, String> serviceOptions = {
    'Consultation dentaire': 'dent_consult',
    'Détartrage complet': 'dent_detartrage',
    'Obturation (plombage)': 'dent_plombage',
    'Radiographie dentaire': 'dent_radio',
  };
  @override
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Consultation dentaire'),
                  const SizedBox(height: 20),
                  _buildOption('Détartrage complet'),
                  const SizedBox(height: 20),
                  _buildOption('Obturation (plombage)'),
                  const SizedBox(height: 20),
                  _buildOption('Radiographie dentaire'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
