...
class orlState extends State<orl> {
  ...
  Specialty specialty = Specialty.orl;
  List<Specialty> availableSpecialties = [];
  List<String> serviceId = [];
  final Map<String, String> serviceOptions = {
    'Suivi post-op amygdales': 'orl_amygdale ',
    'Audiometrie': 'orl_audio ',
    'Consultation ORL': 'orl_consult ',
    'Fibroscopie': 'orl_fibro ',
  };
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Suivi post-op amygdales'),
                  const SizedBox(height: 20),
                  _buildOption(
                    'Audiometrie',
                  ),
                  const SizedBox(height: 20),
                  _buildOption('Consultation ORL'),
                  const SizedBox(height: 20),
                  _buildOption('Fibroscopie'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
