...
class MyApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: HomeS20());
  }
}

class HomeS20 extends StatefulWidget {
  @override
  _HomeS20State createState() => _HomeS20State();
}

class _HomeS20State extends State<HomeS20> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<AlgerianWilayas>(
                    ...
                    items: AlgerianWilayas.values.map((wilaya) {
                          ...
                          if (name.isEmpty ||
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => HomeS10(
                                    ...
                                    closeContact: _closeContactController.text,
                                  ),
                                ),
                              );
                            }
                            ...
                            if (pr == 2) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => HomeS9(
                                    name: _nameController.text,
                                    email: _emailController.text,
                                    address: _addressController.text,
                                    closeContact: _selectedWilaya ?? AlgerianWilayas.alger,
                                  ),
                                ),
                              );
                            }
