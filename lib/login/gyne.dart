...
class GyneState extends State<Gyne> {
  ...
  Specialty specialty = Specialty.gyneco;
  List<Specialty> availableSpecialties = [];
  List<String> serviceId = [];
  final Map<String, String> serviceOptions = {
    'Consultation gynécologique': 'gyneo_consult ',
    'Échographie obstétricale': 'gyneo_echo ',
    'Consultation fertilité': 'gyneo_fiv ',
    'Suivi post-natal': 'gyneo_suivi ',
  };
  @override
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Consultation gynécologique'),
                  const SizedBox(height: 20),
                  _buildOption('Échographie obstétricale'),
                  const SizedBox(height: 20),
                  _buildOption('Consultation fertilité'),
                  const SizedBox(height: 20),
                  _buildOption('Suivi post-natal'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
