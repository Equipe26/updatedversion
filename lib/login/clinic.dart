            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  _buildOption('Gastro-Entérologie'),
                  const SizedBox(height: 20),
      ...
      onTap: () {
        setState(() {
          if (isSelected) {
            ...
            final specialty = Specialty.values.firstWhere(
              (s) => s.displayName == value,
              orElse: () => Specialty.generaliste, // or handle gracefully
            );
