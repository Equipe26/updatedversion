...
class card1State extends State<Card1> {
  ...
  Specialty specialty = Specialty.cardio;
  List<Specialty> availableSpecialties = [];
  List<String> serviceId = [];
  final Map<String, String> serviceOptions = {
    'Consultation cardiologique': 'cardio _consult ',
    'Ecocardiographie': 'cardio _echo ',
    'Suivi-post operatoire': 'cardio_suivi ',
    'Holter tensionnel': 'cardio_holter',
  };
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Consultation cardiologique'),
                  const SizedBox(height: 20),
                  _buildOption('Ecocardiographie'),
                  const SizedBox(height: 20),
