...
class geneState extends State<gene> {
  ...
  final Map<String, String> serviceOptions = {
    'Certificat médical': 'mg_certificat',
    'Consultation générale': 'mg_consult',
    'Pansement complexe': 'mg_pansement',
    'Vaccination adulte': 'mg_vaccin',
  };
  @override
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Certificat médical'),
                  const SizedBox(height: 20),
                  _buildOption('Consultation générale'),
                  const SizedBox(height: 20),
                  _buildOption('Pansement complexe'),
                  const SizedBox(height: 20),
                  _buildOption('Vaccination adulte'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
