...
class ophtoState extends State<ophto> {
  ...
  Specialty specialty = Specialty.ophtalmo;
  // Specialty? specialty;
  List<Specialty> availableSpecialties = [];
  List<String> serviceId = [];
  final Map<String, String> serviceOptions = {
    'Consultation ophtalmologique': 'opht_consult ',
    'Fond d' 'œil': 'opht_fond ',
    'Dépistage presbytie': 'opht_presby ',
    'Tonometrie': 'opht_tono ',
  };
  @override
