...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: Infermier());
  }
}

class Infermier extends StatefulWidget {
  @override
  InfermierState createState() => InfermierState();
}

class InfermierState extends State<Infermier> {
